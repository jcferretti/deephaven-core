...
public class CpuMemTimeDrivenTest {
    ...
    // Each position in the spec array represents one block in a series of consecutive 64 bit longs
    // in the result.
    private static long[] fromBlockSpec(final int[] spec) {
        final long[] r = new long[spec.length];
    ...
    private static boolean areEqual(final long[] r0, final long[] r1) {
    ...
    private static long[] andEqualsCalc(final long[] v0, final long[] v1) {
        final long[] r = new long[v0.length];
    ...
    private static long[] andNotEqualsCalc(final long[] v0, final long[] v1) {
        final long[] r = new long[v0.length];
        for (int i = 0; i < v0.length; ++i) {
            r[i] = v0[i] & ~v1[i];
        }
    ...
    private static long[] orEqualsCalc(final long[] v0, final long[] v1) {
        final long[] r = new long[v0.length];
        for (int i = 0; i < v0.length; ++i) {
            r[i] = v0[i] | v1[i];
        }
    ...
    private static final Map<Operation, BiFunction<long[], long[], long[]>> calcOps = new HashMap<>();
    static {
        calcOps.put(Operation.AND_NOT_EQUALS, CpuMemTimeDrivenTest::andNotEqualsCalc);
        calcOps.put(Operation.AND_EQUALS, CpuMemTimeDrivenTest::andEqualsCalc);
        calcOps.put(Operation.OR_EQUALS, CpuMemTimeDrivenTest::orEqualsCalc);
    }


    private static long[] andEqualsExpected(final long[] v0, final long[] v1) {
        final long[] r = new long[v0.length];
    ...
    private static long[] andNotEqualsExpected(final long[] v0, final long[] v1) {
        final long[] r = new long[v0.length];
        for (int i = v0.length - 1; i >= 0; --i) {
            r[i] = v0[i] & ~v1[i];
        }
    ...
    private static long[] orEqualsExpected(final long[] v0, final long[] v1) {
        final long[] r = new long[v0.length];
        for (int i = v0.length - 1; i >= 0; --i) {
            r[i] = v0[i] | v1[i];
        }
    ...
    private static final Map<Operation, BiFunction<long[], long[], long[]>> expectedOps =
            new HashMap<>();
    static {
        expectedOps.put(Operation.AND_NOT_EQUALS, CpuMemTimeDrivenTest::andNotEqualsExpected);
        expectedOps.put(Operation.AND_EQUALS, CpuMemTimeDrivenTest::andEqualsExpected);
        expectedOps.put(Operation.OR_EQUALS, CpuMemTimeDrivenTest::orEqualsExpected);
    }
    ...
    static class TestWorker implements Runnable {
        ...
        private final BiFunction<long[], long[], long[]> rspOp;
        private final BiFunction<long[], long[], long[]> osetOp;
        ...
        public TestWorker(
                ...
                final Operation op,
                final BiFunction<long[], long[], long[]> rspOp,
                final BiFunction<long[], long[], long[]> osetOp,
                final int nblocks,
    ...
    private static boolean checkBinaryOp(
            final BiFunction<long[], long[], long[]> calcOp,
            final BiFunction<long[], long[], long[]> expectedOp,
            final int[] spec0,
            final int[] spec1) {
        final long[] v0 = fromBlockSpec(spec0);
        final long[] v1 = fromBlockSpec(spec1);
        final long[] c = calcOp.apply(v0, v1);
        final long[] e = expectedOp.apply(v0, v1);
        return areEqual(e, c);
    }
    ...
    public void testAndNotEqualsRandom() {
        ...
        binaryOpsHelper(op, calcOps.get(op), expectedOps.get(op), 8, TestSequenceMode.RANDOM,
